package sandbox.sfwatergit.utils.pt.gtfsUtils.merging;
...
import sandbox.sfwatergit.utils.pt.gtfsUtils.OperatorDataUtility;
...
public class MultiGTFSMerger {
    ...
    public MultiGTFSMerger(String netOutName, String scheduleOutName, String vehiclesOutName) {
        ...
        try {
            ...
            props.load(in);
            outputDir = props.get("gtfs.outputDir").toString();
        } catch (IOException e) {
            e.printStackTrace();
        }
