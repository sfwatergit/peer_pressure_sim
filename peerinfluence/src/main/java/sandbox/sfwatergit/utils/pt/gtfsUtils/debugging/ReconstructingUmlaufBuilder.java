...
public class ReconstructingUmlaufBuilder implements UmlaufBuilder {
	...
	public ReconstructingUmlaufBuilder(Collection<TransitLine> transitLines,
									   Vehicles basicVehicles, MyUmlaufInterpolator myInterpolator) {
		this.umlaufInterpolator = myInterpolator;
