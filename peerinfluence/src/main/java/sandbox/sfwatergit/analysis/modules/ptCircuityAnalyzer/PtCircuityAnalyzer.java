 ...
 *                                                                         *
 * *********************************************************************** */
package sandbox.sfwatergit.analysis.modules.ptCircuityAnalyzer;
...
/**
 * 
 * This travelTime module calculates the beeline distances and the distances
...
public class PtCircuityAnalyzer extends AbstractAnalysisModule {
	...
	public void writeResults(String outputFolder) {
		...
		try {
			...
			bw.write("Player Id" + separator + "ptBeeline" + separator + "ptDistance" + separator + "ptCircuity"
