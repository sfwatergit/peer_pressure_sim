...
package sandbox.sfwatergit.analysis.modules.analysis;
...
public class CongestionEventsWriter {
	...
	private void run() {
		...
		MarginalCongestionPricingHandler marginalCostTollHandler = new MarginalCongestionPricingHandler(scenario,Double.parseDouble(scenario.getConfig().getModules().get(ExternalitiesConfigGroup.GROUP_NAME).getParams().get(ExternalitiesConfigGroup.CONGESTION_COST_FACTOR)));
