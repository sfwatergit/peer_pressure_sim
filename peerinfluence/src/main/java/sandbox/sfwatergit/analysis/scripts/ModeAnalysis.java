 ...
 * <p>
 * This handler must be added as a controller listener: it takes care about adding
...
public class ModeAnalysis implements
    ...
    public void notifyStartup(final StartupEvent event) {
        ...
        final EventsManager events = event.getServices().getEvents();
        if (events != null) {
