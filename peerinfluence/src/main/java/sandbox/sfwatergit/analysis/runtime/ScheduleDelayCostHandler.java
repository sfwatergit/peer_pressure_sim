...
import sandbox.sfwatergit.analysis.modules.welfare.TripAnalysisHandler;
import sandbox.sfwatergit.analysis.runtime.scoring.DisaggregatedSumScoringFunction;
import sandbox.sfwatergit.analysis.runtime.scoring.PersonalScoringFunctionFactory;
import sandbox.sfwatergit.analysis.runtime.scoring.PersonalScoringParameters;
import sandbox.sfwatergit.analysis.runtime.scoring.ScheduleDelayCostHandlerFactory;
...
public class ScheduleDelayCostHandler implements ActivityStartEventHandler, ActivityEndEventHandler, PersonArrivalEventHandler, PersonDepartureEventHandler, PersonEntersVehicleEventHandler, PersonStuckEventHandler, ScheduleDelayCostHandlerFactory {
	...
	public ScheduleDelayCostHandler(){
		...
		this.journeys = new HashMap<Id<Person>, Journey>();
	...
	protected double calcLegScore(final double departureTime, final double arrivalTime, final Leg leg, Id<Person> personId) {
		...
		PersonalScoringParameters.Mode modeParams = scoringParameters.get(personId).modeParams.get(leg.getMode());
		if (modeParams == null) {
