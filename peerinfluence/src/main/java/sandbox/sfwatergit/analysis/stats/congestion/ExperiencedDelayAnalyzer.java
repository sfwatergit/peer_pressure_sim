 ...
 * <p> In order to get the caused delay for each person,
 *
 * @author amit
 */
public class ExperiencedDelayAnalyzer {
    ...
    public void run(){
        ...
        final EventsManager eventsManager = EventsUtils.getParallelFeedableInstance(events);

        final EventsReaderXMLv1 eventsReader = new EventsReaderXMLv1(eventsManager);
