...
import sandbox.sfwatergit.peerinfluence.io.Writer;
 ...
 * @author mrieser
 */
public class LinkOccupancyAnalyzer implements LinkEnterEventHandler, LinkLeaveEventHandler, PersonDepartureEventHandler,  PersonArrivalEventHandler, AfterMobsimListener {
...
//				}
    ...
    private void writeToFileLinkOccupancy(String outputDirectory) {
        ...
        writer.createFile(outputDirectory + "/linksOccupancy.csv");
