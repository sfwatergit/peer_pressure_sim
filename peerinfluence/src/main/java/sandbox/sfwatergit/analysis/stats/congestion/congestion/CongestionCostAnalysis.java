...
package sandbox.sfwatergit.analysis.stats.congestion.congestion;
...
import sandbox.sfwatergit.analysis.modules.analysis.CongestionAnalysisEventHandler;
import sandbox.sfwatergit.analysis.modules.analysis.CongestionAnalysisWriter;
import sandbox.sfwatergit.analysis.stats.congestion.IKGISAnalyzer;
import sandbox.sfwatergit.peerinfluence.internalization.congestion.handlers.CongestionHandlerImplV3;
import sandbox.sfwatergit.peerinfluence.internalization.congestion.handlers.TollHandler;
...
public class CongestionCostAnalysis {
	...
	public static void main(String[] args) {
		...
		if (args.length > 0) {
			...
			runDirectory = "";
			shapeFileZones = "/Users/sfeygin/current_code/python/research/marl/deepmarl/data/tazs/mtc_taz1454_NAD83UTM10N_simple.shp";
			homeActivity = "h1";
			workActivity = "w1";
			scalingFactor = 750;
		}
