...
public class CongestionEventsWriter {
    ...
    static double congestionCostRatio;
    ...
    public static void main(String[] args) {
        ...
        if (args.length > 0) {
            ...
            runDirectory = "/Users/sidneyfeygin/current_code/java/matsim_home/matsim_smartcities/test/output/pt/";
            congestionCostRatio=Double.parseDouble(args[0]);
        }
    ...
    private void run() {
        ...
        config.plans().setInputFile(runDirectory + "population.xml.gz");
        ...
        MarginalCongestionPricingHandler marginalCostTollHandler = new MarginalCongestionPricingHandler(scenario,congestionCostRatio);
